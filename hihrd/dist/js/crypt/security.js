...
Base64.code = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789_/=";
...
function Encrypt(str){
	return Aes.Ctr.encrypt(str, "696d697373796f7568616e6765656e61", 256);
}

function Decrypt(str){
	return Aes.Ctr.decrypt(str, "696d697373796f7568616e6765656e61", 256);
}