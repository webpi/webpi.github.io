...
JustGage = function(config) {
  ...
  obj.config = {
    ...
    titleFontColor: kvLookup('titleFontColor', config, dataset, "#333333"),
    ...
    valueFontColor: kvLookup('valueFontColor', config, dataset, "#eb191c"),
    ...
    gaugeColor: kvLookup('gaugeColor', config, dataset, "#dddddd"),
    ...
    labelFontColor: kvLookup('labelFontColor', config, dataset, "#333333"),
  ...
  if (obj.config.donut === true) {
    ...
    titleX = dx + widgetW / 2;
    titleY = dy + (obj.config.titlePosition === 'below' ? (widgetH * 1.07) : (widgetH / 6.4)) + 15;
    ...
    labelX = dx + widgetW / 2;
    labelY = valueY - valueFontSize;

    // min
    minFontSize = ((widgetH / 16) > obj.config.minLabelMinFontSize) ? (widgetH / 16) : obj.config.minLabelMinFontSize;
    minX = dx + (widgetW / 10) + (widgetW / 6.666666666666667 * obj.config.gaugeWidthScale) - 20;
    minY = labelY + valueFontSize;

    // max
    maxFontSize = ((widgetH / 16) > obj.config.maxLabelMinFontSize) ? (widgetH / 16) : obj.config.maxLabelMinFontSize;
    maxX = dx + widgetW - (widgetW / 10) - (widgetW / 6.666666666666667 * obj.config.gaugeWidthScale) + 25;
    maxY = labelY + valueFontSize;;
  }
