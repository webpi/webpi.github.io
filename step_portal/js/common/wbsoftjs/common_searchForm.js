...
function jsOrgnNmSearch(){
	...
	jQuery.ajax({
		url : ctx +'/common/search/getOrgnNmList.do',
		cache : false,
		async: false,
		dataType: 'json',
		data: {
...
function jsCrsNmSearch(){
	...
	jQuery.ajax({
		url : ctx + '/common/search/getCrsNmList.do',
		cache : false,
		async: false,
		dataType: 'json',
		data: {
...
function jsCrsCpSearch(){
	...
	jQuery.ajax({
		url : ctx + '/common/search/getCrsCpList.do',
		cache : false,
		async: false,
		dataType: 'json',
		data: {
...
//	jQuery('#p_srch_subjseq_viewyn').val('N');
	...
	jQuery.ajax({
		url : ctx + '/common/search/getCrsSeqNmList.do',
		cache : false,
		async: false,
		dataType: 'json',
		data: {
...
function jsEduYearList(year,curyear){
	...
	jQuery.ajax({
		url : ctx + '/common/search/getEduYearList.do',
		cache : false,
		async: false,
		dataType: 'json',
		data: {
...
function jsEduSeqList(){
	selectbox_deletelist('p_srch_eduseq_id');
	jQuery.ajax({
		url : ctx + '/common/search/getEduSeqList.do',
		cache : false,
		async: false,
		dataType: 'json',
		data: {
...
function jsSubjList(){
	...
	jQuery.ajax({
		url : ctx + '/common/search/getSubjCrsList.do',
		cache : false,
		async: false,
		dataType: 'json',
		data: {
...
function jsSubjSeqList(){
	...
	jQuery.ajax({
		url : ctx + '/common/search/getSubjSeqList.do',
		cache : false,
		async: false,
		dataType: 'json',
		data: {
...
function jsWorkPlcSearch(){
	...
	jQuery.ajax({
		url : ctx + '/common/search/getWorkPlcList.do',
		cache : false,
		async: false,
		dataType: 'json',
		data: {
...
// 교육형태에 따른 교육그룹 가져오기
function jsEduGrpSearch(){
	selectbox_deletelist('p_srch_edugrp_id');
	jQuery.ajax({
		url : ctx + '/common/search/getEduGrpList.do',
		cache : false,
		async: false,
		dataType: 'json',
		data: {
			p_srch_edugrp_type: jQuery('#p_srch_edugrp_type').val()
		},
		success : function (data){
			selectbox_insertlist('p_srch_edugrp_id',data.edugrpList);
		}
	});
}
...
function fn_getThisMonth(){
	...
	jQuery("#p_srch_edu_dt_to").val(nowYear+"-"+formatDate(firstDate));
	jQuery("#p_srch_edu_dt_from").val(nowYear+"-"+formatDate(now));
}
