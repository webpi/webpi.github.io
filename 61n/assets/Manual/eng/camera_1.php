...
<h1>MANUAL</h1>
    <div class="contents clearfix">
        <div class="dir"><p><a href="main.php">61N Manual</a> <span> &gt; </span> <a href="camera_1.php">How to Use Camera</a> <span> &gt; </span> <strong>Power</strong></p></div>
        <div class="left clearfix">
            ...
            <ul class="lmenu">
                ...
                <li class="on"><a href="camera_1.php">How to Use Camera</a>
                    <ul class="lmenu">
                      <li class="on"><a href="camera_1.php">Power</a>
                      	<ul class="lmenu">
        ...
        <div class="cright clearfix">
        	<!-- Write contents here -->
            <h2>Power</h2>
            <h3>Turn on Camera</h3><!-- Sub title -->
            <p>It is possible to turn on the camera by pressing to hold a button (4 sec.) on the side of 61N camera. When turning on the camera, LED on top of camera will be displayed with orange color. Later, if booting is completed, LED will be changed to green color and LED display will turn off. </p>
			<h3>Turn off Camera</h3><!-- Sub title -->
            <p>It is possible to turn off the camera by pressing to hold a button (4 sec) on the side of 61N camera. When turning off the camera, LED on top of camera will display green color. Later, when the final process is completed, the green display will flicker 3 times and LED display will turn off. </p>
            <h3>Reset Camera</h3><!-- Sub title -->
            <p>If pressing to hold a button on the side of 61N camera (8 sec.), the camera resets. When the camera resets, LED on top of the camera will display orange color. Later, if rebooting is completed, LED will be changed to green color shortly and LED display will turn off.</p>
