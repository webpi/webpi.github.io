...
<h1>MANUAL</h1>
    <div class="contents clearfix">
        <div class="dir"><p><a href="main.php">61N Manual</a> <span> &gt; </span> <a href="setting_1.php">61N Menu - Setting</a> <span> &gt; </span> <strong>Viewing Policy &amp; Terms</strong></p></div>
            ...
            <ul class="lmenu">
                ...
                <li class="on"><a href="">61N Menu - Setting</a>
                	<ul class="lmenu">
                      ...
                      <li class="on"><a href="setting_10.php">Viewing Policy &amp; Terms</a></li>
        ...
        <div class="cright clearfix">
        	<!-- Write contents here -->
            <h2>Viewing Policy &amp; Terms</h2>
            <!--h3>카메라 등록하기</h3><!-- Sub title -->
            <p>It is possible to examine the policy and terms of 61N. It is possible to examine in the second item of more view tab on setting screen.</p>
