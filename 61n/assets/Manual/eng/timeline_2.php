...
<h1>MANUAL</h1>
    <div class="contents clearfix">
        <div class="dir"><p><a href="main.php">61N Manual</a> <span> &gt; </span> <a href="timeline_1.php">61N Menu - Timeline</a> <span> &gt; </span> <strong>Viewing WITH</strong></p></div>
            ...
            <ul class="lmenu">
                ...
                <li class="on"><a href="">61N Menu - Timeline</a>
                    <ul class="lmenu">
                      ...
                      <li class="on"><a href="timeline_2.php">Viewing WITH</a>
                      	<ul class="lmenu">
        ...
        <div class="cright clearfix">
        	<!-- Write contents here -->
            <h2>Viewing WITH</h2>
            <h3>View WITH Time Line</h3><!-- Sub title -->
            <p>An appearance taken by two people connecting two 61N cameras wirelessly will be seen simultaneously by a divided screen in each smartphone. It is possible to include photos of different point at the same place and photos of different appearances facing each other. The biggest difference of Time Line-WITH mode that appears between when one unit of camera is used and when two units of camera are used is the fact that in WITH mode, the screen is divided to show two photos in parallel in the App instead of one photo. <br>

Please refer to the item 'SETTING' for a method to register WITH partner.</p>
			<h3>View HELLO</h3><!-- Sub title -->
            <p>In a condition when two users registered by WITH wear 61N each other, if they access to each other, the WITH mode will start. When the WITH mode starts, it will combine the first photos taken by 61N camera to display them in the App. At the same time, a text 'HELLO' will be displayed on the bundle, which tells the start of WITH mode.</p>
            <h3>View GOODBYE</h3><!-- Sub title -->
            <p>If two 61N cameras of two users registered by WITH are apart more than a certain distance, the WITH mode will end. When the WITH mode ends, it will gather photos of 61N taken during the time when WITH mode has been maintained, to make a special photo diary only for two people. Flicking the photo story screen to left or right, it is possible to appreciate the time they were together. If touching each photo generated in the photo story, the photo will move to the detail view screen of corresponding photo. Later, it will be possible to use the functions of emotion tag link, hash tag link, share, download, deletion that are provided in the detail view screen. (At this time, it is only possible to use emotion tag link and download for photos taken by a partner among photos included in the photo story) </p>
            <h3>View WITH Statistics</h3><!-- Sub title -->
            <p>If the WITH mode ends, it will display WITH information about which two people were together.  It will display the time sustained with the WITH mode, the distance moved with the WITH mode, and the number of photos two people have taken during the WITH mode.</p>
            <p>&nbsp;</p>
            <!-- // Write contents here -->
        </div>
    </div>
