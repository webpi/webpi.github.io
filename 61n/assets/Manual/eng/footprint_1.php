...
<h1>MANUAL</h1>
    <div class="contents clearfix">
        <div class="dir"><p><a href="main.php">61N Manual</a> <span> &gt; </span> <a href="footprint_1.php">61N Menu - Footprint</a> <span> &gt; </span> <strong>Viewing Photo per Place</strong></p></div>
        <div class="left clearfix">
            ...
            <ul class="lmenu">
                ...
                <li class="on"><a href="">61N Menu - Footprint</a>
                	<ul class="lmenu">
                      <li class="on"><a href="footprint_1.php">Viewing Photo per Place</a>
                      	<ul class="lmenu">
        ...
        <div class="cright clearfix">
        	<!-- Write contents here -->
            <h2>Viewing Photo per Place</h2>
            <h3>View on Map Screen</h3><!-- Sub title -->
            <p>If moving to Footprint Menu, my own photos will be displayed on the map screen. Photos registered on the map screen will be displayed in a specific place as a bundle by gathering photos taken in each corresponding position. Please recollect memories by comparing photos taken in the past at the corresponding place. (Photos taken with more than two 61N cameras will be displayed by classifying photos taken by each camera as a bundle.)</p>
			<h3>View by Lattice</h3><!-- Sub title -->
            <p>If touching photos displayed as a bundle on Footprint screen, photos included in each corresponding bundle can be examined through the lattice type preview screen. On the lattice type view screen, it is possible to select desirable photos in duplicate for batch download, and to select undesirable photos in duplicate for batch deletion.</p>
            <h3>View in Detail</h3><!-- Sub title -->
            <p>If touching the preview on the lattice type view screen, a detail view screen will appear where corresponding photos can be seen through the whole screen. Flicking the detail view screen to left or right, it is possible to appreciate next and previous photos. On the detail view screen, it is possible to use the functions of emotion tag, hash tag, share, download, photo deletion. </p>
