...
<h1>MANUAL</h1>
    <div class="contents clearfix">
        <div class="dir"><p><a href="main.php">61N Manual</a> <span> &gt; </span> <a href="setting_1.php">61N Menu - Setting</a> <span> &gt; </span> <strong>Setting F/F</strong></p></div>
            ...
            <ul class="lmenu">
                ...
                <li class="on"><a href="">61N Menu - Setting</a>
                	<ul class="lmenu">
                      ...
                      <li class="on"><a href="setting_3.php">Setting F/F</a>
                      	<ul class="lmenu">
        ...
        <div class="cright clearfix">
        	<!-- Write contents here -->
            <h2>Setting F/F</h2>
            <h3>Send F/F Code</h3><!-- Sub title -->
            <p>It is possible to transmit my own F/F Album code to the partner by touching a MY F/F ALBUM CODE SEND button in SETTING>SHARE SETTING>F/F ALBUM CONNECTION/CANCELLATION. It is possible to send through SMS or Messenger, E-mail.</p>
			<h3>Register F/F Code</h3><!-- Sub title -->
            <p>After receiving F/F Album code the partner has sent through SMS, Messenger or E-mail, you will be registered to F/F member by entering 8 digit code in “F/F Album Code” input column and touching a "REGISTER RECEIVED F/F ALBUM CODE” button. </p>
            <h3>Cancel F/F</h3><!-- Sub title -->
            <p>If flicking members' tab displayed in the SETTING>SHARE SETTING>F/F ALBUM USER LIST, a DELETION button will be displayed. At this time, if touching the deletion button, corresponding F/F member will be deleted.</p>
