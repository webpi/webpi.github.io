...
<h1>MANUAL</h1>
    <div class="contents clearfix">
        <div class="dir"><p><a href="main.php">61N Manual</a> <span> &gt; </span> <a href="app_1.php">Examine App.</a> <span> &gt; </span> <strong>Examining</strong></p></div>
            ...
            <ul class="lmenu">
                ...
                <li class="on"><a href="app_1.php">Examine App.</a>
                    <ul class="lmenu">
                      ...
                      <li class="on"><a href="app_2.php">Examining</a>
                      	<ul class="lmenu">
        ...
        <div class="cright clearfix">
        	<!-- Write contents here -->
            <h2>Examining</h2>
            <h3>Examine Basic Screen</h3><!-- Sub title -->
            <p>If installing App and creating an account, Time Line screen will appear. The App basic screen (Time Line Screen) is composed of a Profile Bar located at top of screen, a Time Line area at screen center, and a Menu Bar at the bottom of screen. </p>
			<h3>Profile Bar</h3><!-- Sub title -->
            <p>Profile bar shows my own profile photos and name, the remaining battery of registered 61N and the number of photos and videos saved in the camera. If touching profile photo, my registered profile image can be seen through a whole screen. If touching an 'EDIT' button on the right top of whole screen for profile image, the photo, name, birthday, and sex in profile can be moved to the setting screen where they can be registered and edited. <br>

In ‘WITH' mode, it is possible to check the image and name of profile for 'WITH' target person in the righthand area of profile bar.<br>

In ‘MULTI' mode, it shows the remaining battery of camera registered with 'MULTI' mode and the number of photos and videos saved in the camera in the righthand area of profile. </p>
            <h3>Menu Bar</h3><!-- Sub title -->
            <p>Menu Bar consists of 4 menus, which is arranged in sequence of 'Time Line', 'F/F Album', 'Footprint', and 'Setting' from the left. If touching each menu, each one will be moved to its corresponding menu. </p>
            <h3>Time Line</h3><!-- Sub title -->
            <p>This is an area where photos and videos taken with 61N are registered. Based on the position information of photos taken with 61N camera, photos taken at the same place will be expressed as one bundle in the Time Line area. In this bundle, the time, place and number of  photographs at the corresponding place will be displayed. A bundle of latest photographs will be displayed by the preview of bundle. <br>

If touching the preview screen, all photos included in the corresponding bundle can be seen through the lattice type preview screen. On the lattice type preview screen, it is possible to select desired photos in duplicate for a batch download. It is possible to select undesirable photos in duplicate for a batch deletion.  <br>

If touching the preview of lattice type preview screen, a detail view screen will appear where corresponding photos can be seen through a whole screen. In the detail view screen, such functions can be used as emotion tag, hash tag, share, download, and photo deletion.</p>
