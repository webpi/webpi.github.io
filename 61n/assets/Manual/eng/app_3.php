...
<h1>MANUAL</h1>
    <div class="contents clearfix">
        <div class="dir"><p><a href="main.php">61N Manual</a> <span> &gt; </span> <a href="app_1.php">Examine App.</a> <span> &gt; </span> <strong>Photo Registration</strong></p></div>
            ...
            <ul class="lmenu">
                ...
                <li class="on"><a href="app_1.php">Examine App.</a>
                    <ul class="lmenu">
                      ...
                      <li class="on"><a href="app_3.php">Photo Registration</a>
                        <ul class="lmenu">
        ...
        <div class="cright clearfix">
            ...
            <h3>Transmit Photos</h3><!-- Sub title -->
            <p>Photos and videos taken with 61N camera will be registered in MY Time Line. If flicking the Time Line screen down, 'PHOTO TRANSMISSION' button will appear at the right bottom. If touching this button, photos and videos in 61N camera will be transmitted to MY Time Line. All transmitted photos will be saved in my 61N cloud server. Photos in 61N camera will be deleted to procure the capacity of camera. At this time, the time to transmit photos to smartphone from 61N camera is related to the condition of connected network.</p>
			<h3>Android</h3><!-- Sub title -->
            <p>In order to transmit photos and videos in 61N, my smartphone and 61N should be interconnected through a short distance wireless communication.  If touching a 'PHOTO TRANSMISSION' button in Android, App will start searching nearby 61N camera. Later, if registered 61N is found, a pop-up window will appear that asks whether to implement photo transmission. If touching a CHECK button on the pop-up window, it will start transmitting photos and videos to MY Time Line. </p>
            <h3>iOS</h3><!-- Sub title -->
            <p>In order to transmit photos and videos in 61N, my iPhone and 61N should be interconnected through a short distance wireless communication. If touching a 'PHOTO TRANSMISSION' button in iPhone, App will start searching nearby 61N camera. Later, if registered 61N is found, a pop-up window will appear that asks whether to implement photo transmission. If touching the CHECK button on the pop-up window, the screen will switch to the network setting screen to connect 61N with iPhone. If selecting 61N-Direct network on iOS network setting screen to return to App, it will start transmitting photos and videos to MY Time Line. (To connect 61N-Direct, password should be entered once initially.)</p>
