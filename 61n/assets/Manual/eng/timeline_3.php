...
<h1>MANUAL</h1>
    <div class="contents clearfix">
        <div class="dir"><p><a href="main.php">61N Manual</a> <span> &gt; </span> <a href="timeline_1.php">61N Menu - Timeline</a> <span> &gt; </span> <strong>Using Multi-mode</strong></p></div>
            ...
            <ul class="lmenu">
                ...
                <li class="on"><a href="">61N Menu - Timeline</a>
                    <ul class="lmenu">
                      ...
                      <li class="on"><a href="timeline_3.php">Using Multi-mode</a></li>
                    </ul>
                </li>
        ...
        <div class="cright clearfix">
        	<!-- Write contents here -->
            <h2>Using Multi-mode</h2>
            <!--h3>Multi모드 사용하기</h3><!-- Sub title -->
            <p>One user can use two 61N cameras at the same time. Photos that have been taken by each camera will be registered for a different bundle on the Time Line screen. </p>
            <p>&nbsp;</p>
            <!-- // Write contents here -->
        </div>
    </div>
