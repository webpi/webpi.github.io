...
<h1>MANUAL</h1>
    <div class="contents clearfix">
        <div class="dir"><p><a href="main.php">61N Manual</a> <span> &gt; </span> <a href="setting_1.php">61N Menu - Setting</a> <span> &gt; </span> <strong>Viewing Cloud Capacity</strong></p></div>
            ...
            <ul class="lmenu">
                ...
                <li class="on"><a href="">61N Menu - Setting</a>
                	<ul class="lmenu">
                      ...
                      <li class="on"><a href="setting_6.php">Viewing Cloud Capacity</a></li>
        ...
        <div class="cright clearfix">
        	<!-- Write contents here -->
            <h2>Viewing Cloud Capacity</h2>
            <!--h3>카메라 등록하기</h3><!-- Sub title -->
            <p>It is possible to check the cloud capacity that is currently used among the 10GB cloud storage space provided to users. The capacity is displayed in the first list of notice setting tab in SETTING MENU.</p>
