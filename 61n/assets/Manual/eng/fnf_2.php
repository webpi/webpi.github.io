...
<h1>MANUAL</h1>
    <div class="contents clearfix">
        <div class="dir"><p><a href="main.php">61N Manual</a> <span> &gt; </span> <a href="fnf_1.php">61N Menu - F/F Album</a> <span> &gt; </span> <strong>Viewing F/F Photo</strong></p></div>
            ...
            <ul class="lmenu">
                ...
                <li class="on"><a href="">61N Menu - F/F Album</a>
                	<ul class="lmenu">
                      ...
                      <li class="on"><a href="fnf_2.php">Viewing F/F Photo</a></li>
                    </ul>
                </li>
        ...
        <div class="cright clearfix">
        	<!-- Write contents here -->
            <h2>Viewing F/F Photo</h2>
            <!--h3>F/F 사진보기</h3><!-- Sub title -->
            <p>Photos registered in F/F Time Line will be displayed as a white bundle in case of my own registered photos, and as a theme color in case of photos registered by F/F members. If touching preview photos displayed in each bundle, you can appreciate corresponding photos through the detail view screen. Later, it is possible to use the functions of emotion tag link, hash tag link, share, download, deletion provided on the detail view screen.(At this time, it is only possible to use emotion tag link and download for photos registered by F/F member among photos registered in F/F Album.)</p>
