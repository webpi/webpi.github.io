...
<h1>MANUAL</h1>
    <div class="contents clearfix">
        <div class="dir"><p><a href="main.php">61N Manual</a> <span> &gt; </span> <a href="camera_1.php">How to Use Camera</a> <span> &gt; </span> <strong>Backup</strong></p></div>
            ...
            <ul class="lmenu">
                ...
                <li class="on"><a href="camera_1.php">How to Use Camera</a>
                    <ul class="lmenu">
                      ...
                      <li class="on"><a href="camera_5.php">Backup</a></li>
        ...
        <div class="cright clearfix">
            ...
            <h2>Backup</h2>
            <!-- Sub title -->
            <p>If Micro USB port at the bottom of camera is connected to PC with a cable, it is possible to backup saved photos and videos in the camera manually. </p>
