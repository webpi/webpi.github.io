...
<h1>MANUAL</h1>
    <div class="contents clearfix">
        <div class="dir"><p><a href="main.php">61N Manual</a> <span> &gt; </span> <a href="setting_1.php">61N Menu - Setting</a> <span> &gt; </span> <strong>Setting Mobile Data Use</strong></p></div>
            ...
            <ul class="lmenu">
                ...
                <li class="on"><a href="">61N Menu - Setting</a>
                	<ul class="lmenu">
                      ...
                      <li class="on"><a href="setting_8.php">Setting Mobile Data Use</a></li>
        ...
        <div class="cright clearfix">
        	<!-- Write contents here -->
            <h2>Setting Mobile Data Use</h2>
            <!--h3>카메라 등록하기</h3><!-- Sub title -->
            <p>When uploading or downloading 61N photos to the cloud, it is possible to select whether to use a mobile network. It is possible to turn off while turning on the corresponding function in the third item of notice setting tab on the setting screen. If you do not wish to use mobile data, please turn off this function. In this case, photos of 61N camera can be transmitted to the cloud only under the environment of Wi-Fi connection.</p>
