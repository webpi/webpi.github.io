...
<h1>MANUAL</h1>
    <div class="contents clearfix">
        <div class="dir"><p><a href="main.php">61N Manual</a> <span> &gt; </span> <a href="camera_1.php">How to Use Camera</a> <span> &gt; </span> <strong>Recharging</strong></p></div>
            ...
            <ul class="lmenu">
                ...
                <li class="on"><a href="camera_1.php">How to Use Camera</a>
                    <ul class="lmenu">
                      ...
                      <li class="on"><a href="camera_4.php">Recharging</a></li>
        ...
        <div class="cright clearfix">
            ...
            <h2>Recharging</h2>
            <!-- Sub title -->
            <p>If Micro USB port at the bottom of camera is connected to the recharge outlet of PC or Smartphone with a cable, recharging will start. During the recharging of camera, LED on top of camera will display red color. After the completion of recharging, it will display green color. </p>
