...
<h1>MANUAL</h1>
    <div class="contents clearfix">
        <div class="dir"><p><a href="main.php">61N Manual</a> <span> &gt; </span> <a href="camera_1.php">How to Use Camera</a> <span> &gt; </span> <strong>Camera Memory</strong></p></div>
            ...
            <ul class="lmenu">
                ...
                <li class="on"><a href="camera_1.php">How to Use Camera</a>
                    <ul class="lmenu">
                      ...
                      <li class="on"><a href="camera_7.php">Camera Memory</a></li>
                    </ul>
                </li>
        ...
        <div class="cright clearfix">
            ...
            <h2>Camera Memory</h2>
            <!-- Sub title -->
            <p>The number of saved photos and videos in 61N camera can be checked through memory icon and number displayed on App Profile Bar.</p>
            <p>&nbsp;</p>
            <!-- // Write contents here -->
        </div>
    </div>
