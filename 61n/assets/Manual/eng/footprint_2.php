...
<h1>MANUAL</h1>
    <div class="contents clearfix">
        <div class="dir"><p><a href="main.php">61N Manual</a> <span> &gt; </span> <a href="footprint_1.php">61N Menu - Footprint</a> <span> &gt; </span> <strong>Checking My Position</strong></p></div>
            ...
            <ul class="lmenu">
                ...
                <li class="on"><a href="">61N Menu - Footprint</a>
                	<ul class="lmenu">
                      ...
                      <li class="on"><a href="footprint_2.php">Checking My Position</a></li>
                    </ul>
                </li>
        ...
        <div class="cright clearfix">
        	<!-- Write contents here -->
            <h2>Checking My Position</h2>
            <!--h3>내위치 확인하기</h3><!-- Sub title -->
            <p>If touching a 'CHECK MY POSITION' button displayed on right top of Footprint screen, the map screen will move to my present position.</p>
