...
<h1>MANUAL</h1>
    <div class="contents clearfix">
        <div class="dir"><p><a href="main.php">61N Manual</a> <span> &gt; </span> <a href="camera_1.php">How to Use Camera</a> <span> &gt; </span> <strong>Video</strong></p></div>
            ...
            <ul class="lmenu">
                ...
                <li class="on"><a href="camera_1.php">How to Use Camera</a>
                    <ul class="lmenu">
                      ...
                      <li class="on"><a href="camera_3.php">Video</a>
                      	<ul class="lmenu">
                        	<li class="on"><a href="camera_3.php">Video Recording</a></li>
                        </ul>
                      </li>
        ...
        <div class="cright clearfix">
        	<!-- Write contents here -->
            <h2>Video</h2>
            <h3>Video Recording</h3><!-- Sub title -->
            <p>Only manual video recording is possible. If pressing ON/OFF button on the side two times shortly, video recording will start. LED light will turn on with orange color as much as the preset recording time. If the preset photographing time ends or the button is pressed one more time during the photographing, LED light will turn off to end recording.</p>
