...
<h1>MANUAL</h1>
    <div class="contents clearfix">
        <div class="dir"><p><a href="main.php">61N Manual</a> <span> &gt; </span> <a href="setting_1.php">61N Menu - Setting</a> <span> &gt; </span> <strong>Setting WITH</strong></p></div>
            ...
            <ul class="lmenu">
                ...
                <li class="on"><a href="">61N Menu - Setting</a>
                	<ul class="lmenu">
                      ...
                      <li class="on"><a href="setting_2.php">Setting WITH</a>
                      	<ul class="lmenu">
        ...
        <div class="cright clearfix">
        	<!-- Write contents here -->
            <h2>Setting WITH</h2>
            <h3>Send WITH Code</h3><!-- Sub title -->
            <p>Two users can register each other for WITH partner when they check the normal connection of 61N camera with smartphone.<br>

It is possible to send my own code to a partner by touching a WITH CODE SEND button in SETTING>SHARE SETTING>WITH CONNECTION/CANCELLATION>WITH INVITATION. It is possible to send through SMS or Messenger, E-mail.</p>
			<h3>Register WITH Code</h3><!-- Sub title -->
            <p>After receiving WITH code the partner has sent through SMS, Messenger or E-mail, you will be connected to the partner by entering 8 digit code in “WITH Code” input column and pressing a “REGISTER RECEIVED WITH CODE” button. If two users who wish to register by WITH complete the corresponding process, two people will be registered by WITH. </p>
            <h3>Cancel WITH</h3><!-- Sub title -->
            <p>It cancels the registration of WITH partner. If a user registered by WITH accesses to SETTING>SHARE SETTING>WITH CONNECTION/CANCELLATION, it is possible to check the condition information of two users registered by current WITH. If touching a 'WITH CANCELLATION' button at the bottom of screen, current WITH will be cancelled and a cancellation notice will be delivered to the partner.</p>
