...
<h1>MANUAL</h1>
    <div class="contents clearfix">
        <div class="dir"><p><a href="main.php">61N Manual</a> <span> &gt; </span> <a href="camera_1.php">How to Use Camera</a> <span> &gt; </span> <strong>Photographing</strong></p></div>
            ...
            <ul class="lmenu">
                ...
                <li class="on"><a href="camera_1.php">How to Use Camera</a>
                    <ul class="lmenu">
                      ...
                      <li class="on"><a href="camera_2.php">Photographing</a>
                      	<ul class="lmenu">
        ...
        <div class="cright clearfix">
        	<!-- Write contents here -->
            <h2>Photographing</h2>
            <h3>Automatic Photographing</h3><!-- Sub title -->
            <p>61N camera can be attached to a cloth or fixed to a specific place. It is not necessary for a special control to take photo. If the camera is attached to a cloth or a bag, a scene that a user is watching will be taken automatically. If the camera is placed at one place or attached to a cup or a water bottle with a band, it is possible to take a self camera or a desirable spot.</p>
			<h3>Manual Photographing</h3><!-- Sub title -->
            <p>As automatic photographing sets instantly at the moment when turning on 61N camera, continuous photographing is possible. However, if anyone wishes to take a certain specific moment, it is possible for photographing anytime regardless of an interval of photographing. If tapping the front part of 61N camera twice, LED on top of camera will display orange color for one second. Instant photographing will be done at the moment when LED turns off.</p>
