...
<h1>MANUAL</h1>
    <div class="contents clearfix">
        <div class="dir"><p><a href="main.php">61N Manual</a> <span> &gt; </span> <a href="app_1.php">Examine App.</a> <span> &gt; </span> <strong>Starting</strong></p></div>
        <div class="left clearfix">
            ...
            <ul class="lmenu">
                ...
                <li class="on"><a href="app_1.php">Examine App.</a>
                    <ul class="lmenu">
                      <li class="on"><a href="app_1.php">Starting</a>
                      	<ul class="lmenu">
        ...
        <div class="cright clearfix">
            ...
            <p>It is possible to create an account through Facebook or E-mail. </p>
			<h3>Log In</h3><!-- Sub title -->
            <p>It is possible to log in with subscribed Facebook account or E-mail account.</p>
            <h3>Find Password</h3><!-- Sub title -->
            <p>If touching 'FIND PASSWORD' below the password input column on login screen, it will be possible to receive a temporary password through my own subscribed E-mail account. (temporary password is case sensitive.)</p>
