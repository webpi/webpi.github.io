...
<h1>MANUAL</h1>
    <div class="contents clearfix">
        <div class="dir"><p>61N Manual <span> &gt; </span> <!--Using 61N <span> &gt; </span--> <strong>Use 61N First Time</strong></p></div>
        <div class="left clearfix">
            <nav id="powermenu1" class="powerlistmenu">
            <ul class="lmenu">
                <li class="on">Use 61N First Time</li>
        ...
        <div class="cright clearfix">
        	<!-- Write contents here -->
            <h2>Use 61N First Time</h2>
            <h3>App. Installation</h3><!-- Sub title -->
            <p>Search "61N" at Google Play store & Apple and download</p>
            <h3>Account Creation</h3><!-- Sub title -->
            <p>Possible to create Facebook Account or E-mail Account</p>
            <h3>Camera Interconnection</h3><!-- Sub title -->
            <p>Access to APP. MENU SETTING>61N CAMERA SETTING>61N CAMERA REGISTRATION, and press the power button of 61N camera 5 times continuously in short. Later, touch 'SEARCH' button at the bottom of screen to register 61N camera. When 61N camera is registered, my own 61N camera will be displayed at 'EQUIPMENT LIST' at the bottom of screen in ‘61N Camera Setting’.</p>
            <h3>Photo Registration</h3><!-- Sub title -->
            <p>Photos and videos taken by 61N camera will be registered in My Time Line. If flicking Time Line screen below, a 'Photo Transmission' button will appear at the right bottom. If touching this button, photos and videos in 61N camera will be transmitted to My Time Line. All transmitted photos will be saved in my 61N cloud server, and photos saved in 61N camera will be deleted and the capacity of camera will be procured. At this time, the time to transmit photos from 61N camera to smartphone is related to the condition of connected network.</p>
