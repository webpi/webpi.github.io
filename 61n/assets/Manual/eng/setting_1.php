...
<h1>MANUAL</h1>
    <div class="contents clearfix">
        <div class="dir"><p><a href="main.php">61N Manual</a> <span> &gt; </span> <a href="setting_1.php">61N Menu - Setting</a> <span> &gt; </span> <strong>Setting Account</strong></p></div>
        <div class="left clearfix">
            ...
            <ul class="lmenu">
                ...
                <li class="on"><a href="">61N Menu - Setting</a>
                	<ul class="lmenu">
                      <li class="on"><a href="setting_1.php">Setting Account</a>
                      	<ul class="lmenu">
        ...
        <div class="cright clearfix">
            ...
            <h3>Register Profile Photo</h3><!-- Sub title -->
            <p>It is possible to register profile photos if touching the photo registration icon in the area of SETTING>ACCOUNT SETTING>PROFILE.</p>
			<h3>Register Name</h3><!-- Sub title -->
            <p>It is possible to register profile name. It is possible to enter name to use for the profile on the name input tab in the area of SETTING>ACCOUNT SETTING>PROFILE.</p>
            <h3>Set Birthday</h3><!-- Sub title -->
            <p>It is possible to register birthday. It is possible to set my own birthday on the birthday setting tab in the area of SETTING>ACCOUNT SETTING>PROFILE.</p>
            <h3>Set Sex</h3><!-- Sub title -->
            <p>It is possible to register sex. It is possible to set my own sex on the sex setting tab in the area of SETTING>ACCOUNT SETTING>PROFILE.</p>
            <h3>Switch from Facebook Account to 61N Account</h3><!-- Sub title -->
            <p>Users who have subscribed the membership in Facebook account can switch to E-mail account. If touching SETTING>ACCOUNT SETTING>ACCOUNT SETTING TAB, it will be possible to switch the account by entering E-mail and password for the account.</p>
            <h3>Change Password</h3><!-- Sub title -->
            <p>Uses who have subscribed the membership through E-mail account can change the password set by themselves. If touching SETTING>ACCOUNT SETTING>ACCOUNT SETTING TAB, it will be possible to use 'Password Change' on the second tab of account area. It is possible to change the account password by entering current password and new password.</p>
            <h3>Withdraw Membership</h3><!-- Sub title -->
            <p>If touching SETTING>ACCOUNT SETTING>ACCOUNT SETTING TAB, a membership cancellation tab will appear. If a membership cancellation is proceeded, all photos and videos registered in My Time Line will be deleted.</p>
