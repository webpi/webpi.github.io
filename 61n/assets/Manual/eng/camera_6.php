...
<h1>MANUAL</h1>
    <div class="contents clearfix">
        <div class="dir"><p><a href="main.php">61N Manual</a> <span> &gt; </span> <a href="camera_1.php">How to Use Camera</a> <span> &gt; </span> <strong>Camera Battery</strong></p></div>
            ...
            <ul class="lmenu">
                ...
                <li class="on"><a href="camera_1.php">How to Use Camera</a>
                    <ul class="lmenu">
                      ...
                      <li class="on"><a href="camera_6.php">Camera Battery</a></li>
        ...
        <div class="cright clearfix">
            ...
            <!-- Sub title -->
            <p>The information of remaining battery of 61N camera can be checked through battery icon and number displayed on App Profile Bar.</p>
