...
<div class="wrap">
    ...
    <div class="contents clearfix">
        <div class="dir"><p><a href="main.php">61N 매뉴얼</a> <span> &gt; </span> <a href="camera_1.php">카메라 사용하기</a> <span> &gt; </span> <strong>전원</strong></p></div>
        <div class="left clearfix">
            ...
            <ul class="lmenu">
                ...
                <li class="on"><a href="camera_1.php">카메라 사용하기</a>
                    <ul class="lmenu">
                      <li class="on"><a href="camera_1.php">전원</a>
                      	<ul class="lmenu">
        ...
        <div class="cright clearfix">
        	<!-- Write contents here -->
            <h2>전원</h2>
            <h3>카메라 켜기</h3><!-- Sub title -->
            <p>61N 카메라의 옆면에 있는 버튼을 길게 (2초 가량)눌러 카메라를 켤 수 있습니다. 카메라를 켤 때, 카메라 윗부분의 LED가 오렌지색으로 표시됩니다. 이후 부팅이 완료되면 LED가 녹색으로 잠시 변경된 후 LED 표시가 꺼집니다.</p>
			<h3>카메라 끄기</h3><!-- Sub title -->
            <p>61N 카메라의 옆면에 있는 버튼을 길게 (2초 가량)눌러 카메라를 끌 수 있습니다. 카메라를 끌 때, 카메라 윗부분의 LED가 녹색으로 표시됩니다. 이후 종료과정이 완료되면 녹색표시가 세 번 점등된 후 LED 표시가 꺼집니다.</p>
            <h3>카메라 다시시작</h3><!-- Sub title -->
            <p>61N 카메라의 옆면에 있는 버튼을 더 길게(8초)누르면 카메라가 재시작(reset) 됩니다. 카메라가 재시작 될 때, 카메라 윗부분의 LED가 오렌지색으로 표시됩니다. 이후 재부팅이 완료되면 LED가 녹색으로 잠시 변경된 후 LED 표시가 꺼집니다.</p>
