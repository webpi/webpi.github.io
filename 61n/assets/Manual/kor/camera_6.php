...
<div class="wrap">
    ...
    <div class="contents clearfix">
        <div class="dir"><p><a href="main.php">61N 매뉴얼</a> <span> &gt; </span> <a href="camera_1.php">카메라 사용하기</a> <span> &gt; </span> <strong>카메라 배터리</strong></p></div>
            ...
            <ul class="lmenu">
                ...
                <li class="on"><a href="camera_1.php">카메라 사용하기</a>
                    <ul class="lmenu">
                      ...
                      <li class="on"><a href="camera_6.php">카메라 배터리</a></li>
        ...
        <div class="cright clearfix">
        	<!-- Write contents here -->
            <h2>카메라 사용하기</h2>
            <h3>카메라 배터리</h3><!-- Sub title -->
            <p>61N 카메라의 배터리 잔량정보는 앱 프로필바에 표시되어있는 배터리 아이콘과 숫자를 통해 확인 할 수 있습니다.</p>
