...
<div class="wrap">
    ...
    <div class="contents clearfix">
        <div class="dir"><p><a href="main.php">61N 매뉴얼</a> <span> &gt; </span> <a href="setting_1.php">61N 메뉴 - 설정하기</a> <span> &gt; </span> <strong>클라우드 용량보기</strong></p></div>
            ...
            <ul class="lmenu">
                ...
                <li class="on"><a href="">61N 메뉴 - 설정하기</a>
                	<ul class="lmenu">
                      ...
                      <li class="on"><a href="setting_6.php">클라우드 용량보기</a></li>
        ...
        <div class="cright clearfix">
            ...
            <p>사용자에게 제공되는 10GB의 클라우드 저장공간 중 자신이 현재 사용하고 있는 클라우드 용량을 확인할 수 있습니다. 설정메뉴의 알림설정 탭 첫 번째 목록에 표시됩니다.</p>
