...
<div class="wrap">
    ...
    <div class="contents clearfix">
        <div class="dir"><p><a href="main.php">61N 매뉴얼</a> <span> &gt; </span> <a href="setting_1.php">61N 메뉴 - 설정하기</a> <span> &gt; </span> <strong>WITH 설정하기</strong></p></div>
            ...
            <ul class="lmenu">
                ...
                <li class="on"><a href="">61N 메뉴 - 설정하기</a>
                	<ul class="lmenu">
                      ...
                      <li class="on"><a href="setting_2.php">WITH 설정하기</a>
                      	<ul class="lmenu">
        ...
        <div class="cright clearfix">
        	<!-- Write contents here -->
            <h2>WITH 설정하기</h2>
            <h3>WITH코드 보내기</h3><!-- Sub title -->
            <p>정상적으로 61N 카메라와 스마트폰이 연결이 된 것을 확인한 두 사용자가 서로를 WITH 파트너로 등록할 수 있습니다.<br>
설정 > 공유설정 >  WITH 연결/해지> WITH 초대하기에서 나의 WITH 코드 보내기 버튼을 터치하여 자신의 코드를 상대에게 전송할 수 있습니다. SMS나 메신저, 이메일을 통해 보낼 수 있습니다.</p>
			<h3>WITH코드 등록하기</h3><!-- Sub title -->
            <p>상대방이 보낸 WITH 코드를 SMS, 메신저, 이메일을 통해 받은 다음 8자리 코드를 “WITH Code” 입력란에 입력하고 “받은 WITH 코드 등록하기” 버튼을 누르면 상대와 파트너로 연결이 됩니다. WITH로 등록하고자 하는 두 사용자가 모두 해당과정을 진행완료하게 되면 두 사람이 WITH로 등록됩니다.</p>
            <h3>WITH 해지하기</h3><!-- Sub title -->
            <p>WITH 파트너 등록을 해지합니다. WITH로 등록된 사용자가 설정> 공유설정>  WITH 연결/해지로 접근하면 현재 WITH로 등록된 두 사용자의 상태정보를 확인할 수 있습니다. 화면 하단의 ‘WITH 해지하기’ 버튼을 터치하면 현재의 WITH가 해지되고 상대방에게 해지알림 메시지가 전달됩니다.</p>
