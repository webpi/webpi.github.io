...
<div class="wrap">
    ...
    <div class="contents clearfix">
        <div class="dir"><p><a href="main.php">61N 매뉴얼</a> <span> &gt; </span> <a href="timeline_1.php">61N 메뉴 - Timeline</a> <span> &gt; </span> <strong>Multi모드 사용하기</strong></p></div>
            ...
            <ul class="lmenu">
                ...
                <li class="on"><a href="">61N 메뉴 - Timeline</a>
                    <ul class="lmenu">
                      ...
                      <li class="on"><a href="timeline_3.php">Multi모드 사용하기</a></li>
                    </ul>
                </li>
        ...
        <div class="cright clearfix">
            ...
            <p>한 명의 사용자가 두 대의 61N을 동시에 사용할 수 있습니다. 각각의 카메라로 촬영된 사진들은 타임라인화면에 다른 묶음으로 등록됩니다.</p>
            <p>&nbsp;</p>
            <!-- // Write contents here -->
        </div>
    </div>
