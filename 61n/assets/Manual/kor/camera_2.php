...
<div class="wrap">
    ...
    <div class="contents clearfix">
        <div class="dir"><p><a href="main.php">61N 매뉴얼</a> <span> &gt; </span> <a href="camera_1.php">카메라 사용하기</a> <span> &gt; </span> <strong>사진찍기</strong></p></div>
            ...
            <ul class="lmenu">
                ...
                <li class="on"><a href="camera_1.php">카메라 사용하기</a>
                    <ul class="lmenu">
                      ...
                      <li class="on"><a href="camera_2.php">사진찍기</a>
                      	<ul class="lmenu">
        ...
        <div class="cright clearfix">
        	<!-- Write contents here -->
            <h2>사진찍기</h2>
            <h3>자동촬영</h3><!-- Sub title -->
            <p>61N 카메라를 옷에 부착하거나 특정 장소에 고정을 할 수 있습니다. 사진을 찍기 위해 특별한 조작을 할 필요가 없습니다. 옷이나 가방에 부착하면 사용자가 보고 있는 장면이 자동으로 촬영이 됩니다. 한 장소에 세워 두거나 밴드를 이용해 컵이나, 물병에 부착을 하면 셀카를 찍거나 원하는 곳을 촬영하도록 할 수 있습니다.</p>
			<h3>수동촬영</h3><!-- Sub title -->
            <p>자동촬영은 61N 카메라를 켜는 순간 설정이 되는 것이므로 항상 촬영이 되지만, 어떤 특정 순간을 찍고 싶은 경우에는 촬영간격에 상관없이 언제든 촬영이 가능합니다. 61N 카메라의 전면부를 두번 탭을 하게 되면 카메라 상단의 LED가 1초간 오렌지색으로 표시되며 LED가 꺼지는 순간 촬영이 이루어 집니다.</p>
