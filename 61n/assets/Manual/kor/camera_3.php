...
<div class="wrap">
    ...
    <div class="contents clearfix">
        <div class="dir"><p><a href="main.php">61N 매뉴얼</a> <span> &gt; </span> <a href="camera_1.php">카메라 사용하기</a> <span> &gt; </span> <strong>동영상</strong></p></div>
            ...
            <ul class="lmenu">
                ...
                <li class="on"><a href="camera_1.php">카메라 사용하기</a>
                    <ul class="lmenu">
                      ...
                      <li class="on"><a href="camera_3.php">동영상</a>
                      	<ul class="lmenu">
                        	<li class="on"><a href="camera_3.php">동영상녹화</a></li>
                        </ul>
                      </li>
        ...
        <div class="cright clearfix">
        	<!-- Write contents here -->
            <h2>동영상</h2>
            <h3>동영상녹화</h3><!-- Sub title -->
            <p>동영상 녹화는 수동 녹화만 가능합니다. 옆면의 On/Off 버튼을 두 번 짧게 누르면 동영상 녹화가 시작됩니다. 녹화를 하는 동안 설정된 녹화 시간만큼 LED가 오렌지색으로 점등되며, 설정된 촬영 시간이 종료 되거나, 녹화도중 버튼을 한 번 더 누르게 되면 LED 점등이 중단되고 녹화가 종료됩니다.</p>
