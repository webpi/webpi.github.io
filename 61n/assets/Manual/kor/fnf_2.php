...
<div class="wrap">
    ...
    <div class="contents clearfix">
        <div class="dir"><p><a href="main.php">61N 매뉴얼</a> <span> &gt; </span> <a href="fnf_1.php">61N 메뉴 - F/F Album</a> <span> &gt; </span> <strong>F/F 사진보기</strong></p></div>
            ...
            <ul class="lmenu">
                ...
                <li class="on"><a href="">61N 메뉴 - F/F Album</a>
                	<ul class="lmenu">
                      ...
                      <li class="on"><a href="fnf_2.php">F/F 사진보기</a></li>
                    </ul>
                </li>
        ...
        <div class="cright clearfix">
            ...
            <p>F/F 타임라인에 등록된 사진들은 자신이 등록한 사진의 경우 흰색 묶음으로 표시되고, F/F 멤버들이 등록한 사진의 경우 테마색으로 표시됩니다. 각 묶음에 표시된 미리보기 사진을 터치하면 해당 사진을 상세보기 화면으로 감상할 수 있습니다. 이후 상세보기 화면에서 제공하는 감정태그달기, 해시태그달기, 공유하기, 다운로드하기, 삭제하기 기능을 이용하실 수 있습니다. (이때 F/F Album에 등록된 사진중 F/F 멤버가 등록한 사진에 대해서는 감정태그달기와 다운로드하기만을 이용할 수 있습니다.)</p>
