...
<div class="wrap">
    ...
    <div class="contents clearfix">
        <div class="dir"><p><a href="main.php">61N 매뉴얼</a> <span> &gt; </span> <a href="camera_1.php">카메라 사용하기</a> <span> &gt; </span> <strong>충전하기</strong></p></div>
            ...
            <ul class="lmenu">
                ...
                <li class="on"><a href="camera_1.php">카메라 사용하기</a>
                    <ul class="lmenu">
                      ...
                      <li class="on"><a href="camera_4.php">충전하기</a></li>
        ...
        <div class="cright clearfix">
        	<!-- Write contents here -->
            <h2>카메라 사용하기</h2>
            <h3>충전하기</h3><!-- Sub title -->
            <p>카메라 밑면의 Micro USB 포트에 케이블을 연결하여 PC 혹은 스마트폰 충전용 콘센트에 연결하면 충전이 시작됩니다. 카메라가 충전중일 때는 카메라 윗부분의 LED가 빨강색으로 표시되며, 충전이 완료된 후에는 녹색으로 표시됩니다.</p>
