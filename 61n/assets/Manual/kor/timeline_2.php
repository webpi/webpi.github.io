...
<div class="wrap">
    ...
    <div class="contents clearfix">
        <div class="dir"><p><a href="main.php">61N 매뉴얼</a> <span> &gt; </span> <a href="timeline_1.php">61N 메뉴 - Timeline</a> <span> &gt; </span> <strong>WITH 보기</strong></p></div>
            ...
            <ul class="lmenu">
                ...
                <li class="on"><a href="">61N 메뉴 - Timeline</a>
                    <ul class="lmenu">
                      ...
                      <li class="on"><a href="timeline_2.php">WITH 보기</a>
                      	<ul class="lmenu">
        ...
        <div class="cright clearfix">
        	<!-- Write contents here -->
            <h2>WITH 보기</h2>
            <h3>WITH타임라인 보기</h3><!-- Sub title -->
            <p>61N 카메라 2대를 무선으로 연결하여 두 사람이 착용하고 있는 카메라에서 찍히는 모습이 각 사용자의 스마트폰에 분할화면으로 동시에 보여지게 됩니다. 같은 자리에서 다른 시점의 사진을 담을 수 있고, 서로를 마주보며 서로의 모습을 담을 수도 있습니다. 카메라 1대를 쓸 때 나타나는 Timeline 모드와 2대를 쓸 때 나타나는 Timeline-WITH 모드의 가장 큰 차이점은 WITH 모드에서는 화면분할이 되어 1장의 사진 대신 두 장의 사진이 나란히 앱에서 보여지게 된다는 것입니다. <br>
WITH 파트너를 등록하는 방법은 ‘설정하기’ 항목을 참고해 주세요.</p>
			<h3>HELLO 보기</h3><!-- Sub title -->
            <p>WITH로 등록된 두 사용자가 서로의 61N을 착용하고 있는 상태에서 서로에게 접근하면 WITH 모드가 시작됩니다. WITH 모드가 시작될 때 각자의 61N카메라가 찍은 첫 번째 사진을 묶어서 앱에 표시합니다. 이와 동시에 WITH 모드가 시작됨을 알리는 'HELLO'라는 텍스트가 묶음의 위에 표시됩니다.</p>
            <h3>GOODBYE 보기</h3><!-- Sub title -->
            <p>WITH로 등록된 두 사용자의 61N이 일정거리이상 멀어지게 되면 WITH 모드가 종료됩니다. WITH 모드가 종료될 때 WITH 모드가 유지되었던 시간동안 촬영된 61N 사진을 모아서 두 사람만의 특별한 포토일기를 만들어 줍니다. 포토스토리 화면을 좌/우로 플리킹하여 두 사람이 함께한 시간을 감상할 수 있습니다. 포토스토리에서 재생되는 각각의 사진을 터치하면 해당사진의 상세보기 화면으로 이동합니다. 이후 상세보기 화면에서 제공하는 감정태그달기, 해시태그달기, 공유하기, 다운로드하기, 삭제하기 기능을 이용하실 수 있습니다. (이때 포토스토리에 포함된 사진중 상대방이 찍은 사진에 대해서는 감정태그달기와 다운로드하기만을 이용할 수 있습니다.)</p>
            <h3>WITH 통계보기</h3><!-- Sub title -->
            <p>WITH 모드가 종료되면 두 사람이 함께한 WITH 정보를 표시해 줍니다. WITH 모드가 지속된 시간, WITH 모드동안 이동한 거리, WITH 모드동안 두 사람이 촬영한 사진의 개수가 표시됩니다.</p>
            <p>&nbsp;</p>
            <!-- // Write contents here -->
        </div>
    </div>
