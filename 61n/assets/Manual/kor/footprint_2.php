...
<div class="wrap">
    ...
    <div class="contents clearfix">
        <div class="dir"><p><a href="main.php">61N 매뉴얼</a> <span> &gt; </span> <a href="footprint_1.php">61N 메뉴 - Footprint</a> <span> &gt; </span> <strong>내위치 확인하기</strong></p></div>
            ...
            <ul class="lmenu">
                ...
                <li class="on"><a href="">61N 메뉴 - Footprint</a>
                	<ul class="lmenu">
                      ...
                      <li class="on"><a href="footprint_2.php">내위치 확인하기</a></li>
                    </ul>
                </li>
        ...
        <div class="cright clearfix">
            ...
            <p>Footprint 화면의 오른쪽 상단에 표시된 ‘내위치 확인하기’ 버튼을 터치하면 현재 나의 위치로 지도화면이 이동하게 됩니다.</p>
