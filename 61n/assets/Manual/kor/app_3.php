...
<div class="wrap">
    ...
    <div class="contents clearfix">
        <div class="dir"><p><a href="main.php">61N 매뉴얼</a> <span> &gt; </span> <a href="app_1.php">앱 살펴보기</a> <span> &gt; </span> <strong>사진등록하기</strong></p></div>
            ...
            <ul class="lmenu">
                ...
                <li class="on"><a href="app_1.php">앱 살펴보기</a>
                    <ul class="lmenu">
                      ...
                      <li class="on"><a href="app_3.php">사진등록하기</a>
                        <ul class="lmenu">
        ...
        <div class="cright clearfix">
        	<!-- Write contents here -->
            <h2>사진등록하기</h2>
            <h3>사진전송하기</h3><!-- Sub title -->
            <p>61N 카메라로 촬영한 사진 및 비디오는 나의 타임라인에 등록됩니다. 타임라인 화면을 아래로 플리킹하면 오른쪽 하단에 ‘사진전송’ 버튼이 나타나고, 이 버튼을 터치하면 61N 카메라에 있는 사진 및 비디오가 나의 타임라인에 전송됩니다. 전송된 사진은 모두 자신의 61N 클라우드 서버에 저장이 되고, 61N 카메라에 있던 사진은 지워지고, 카메라 용량이 확보됩니다. 이때 61N 카메라에서 스마트폰으로 사진이 전송되는 시간은 접속되어 있는 네트워크의 상태와 연관이 있습니다.</p>
			<h3>안드로이드</h3><!-- Sub title -->
            <p>61N에 있는 사진 및 비디오를 전송하기 위해서는 자신의 스마트폰과 61N이 근거리 무선통신으로 연동되어야 합니다. Android 에서 ‘사진전송’ 버튼을 터치하면 앱은 근처의 61N 카메라를 찾기 시작합니다. 이후 등록된 61N을 찾게 되면 사진전송을 실행할 것인지를 묻는 팝업창이 나타납니다. 팝업창에서 확인 버튼을 터치하면 사진 및 비디오가 나의 타임라인에 전송되기 시작합니다. </p>
            <h3>iOS</h3><!-- Sub title -->
            <p>61N에 있는 사진 및 비디오를 전송하기 위해서는 자신의 아이폰과 61N이 근거리 무선통신으로 연동되어야 합니다. 아이폰에서 ‘사진전송’ 버튼을 터치하면 앱은 근처의 61N 카메라를 찾기 시작합니다. 이후 등록된 61N을 찾게 되면 사진전송을 실행할 것인지를 묻는 팝업창이 나타납니다. 팝업창에서 확인 버튼을 터치하면 61N과 아이폰을 연결하기 위해 네트워크 설정화면으로 이동하게 됩니다. iOS 네트워크 설정화면에서 61N-Direct 네트워크를 선택 후 앱으로 복귀하면 사진 및 비디오가 나의 타임라인에 전송되기 시작합니다. (61N-Direct 연결을 위해 비밀번호를 최초 1회 입력해야 합니다.)</p>
