...
<div class="wrap">
    ...
    <div class="contents clearfix">
        <div class="dir"><p><a href="main.php">61N 매뉴얼</a> <span> &gt; </span> <a href="setting_1.php">61N 메뉴 - 설정하기</a> <span> &gt; </span> <strong>F/F 설정하기</strong></p></div>
            ...
            <ul class="lmenu">
                ...
                <li class="on"><a href="">61N 메뉴 - 설정하기</a>
                	<ul class="lmenu">
                      ...
                      <li class="on"><a href="setting_3.php">F/F 설정하기</a>
                      	<ul class="lmenu">
        ...
        <div class="cright clearfix">
        	<!-- Write contents here -->
            <h2>F/F 설정하기</h2>
            <h3>F/F 코드 보내기</h3><!-- Sub title -->
            <p>설정> 공유설정>  F/F Album 연결/해지 에서 나의 F/F Album 코드 보내기 버튼을 터치하여 자신의 F/F Album 코드를 상대에게 전송할 수 있습니다. SMS나 메신저, 이메일을 통해 보낼 수 있습니다.</p>
			<h3>F/F 코드 등록하기</h3><!-- Sub title -->
            <p>상대방이 보낸 F/F Album 코드를 SMS, 메신저, 이메일을 통해 받은 다음 8자리 코드를 “F/F Album Code” 입력란에 입력하고 “받은 F/F Album 코드 등록하기” 버튼을 누르면 F/F 멤버로 등록됩니다. </p>
            <h3>F/F 해지하기</h3><!-- Sub title -->
            <p>설정> 공유설정>  F/F Album 사용자목록에서 표시되는 멤버들의 탭을 왼쪽으로 플리킹하면 삭제하기 버튼이 표시됩니다. 이때 삭제버튼을 터치하면 해당 F/F 멤버가 삭제됩니다.</p>
