...
<div class="wrap">
    ...
    <div class="contents clearfix">
        <div class="dir"><p><a href="main.php">61N 매뉴얼</a> <span> &gt; </span> <a href="setting_1.php">61N 메뉴 - 설정하기</a> <span> &gt; </span> <strong>계정 설정하기</strong></p></div>
        <div class="left clearfix">
            ...
            <ul class="lmenu">
                ...
                <li class="on"><a href="">61N 메뉴 - 설정하기</a>
                	<ul class="lmenu">
                      <li class="on"><a href="setting_1.php">계정 설정하기</a>
                      	<ul class="lmenu">
        ...
        <div class="cright clearfix">
        	<!-- Write contents here -->
            <h2>계정 설정하기</h2>
            <h3>프로필 사진 등록하기</h3><!-- Sub title -->
            <p>프로필 사진을 등록할 수 있습니다. 설정> 계정설정 > 프로필 영역의 사진등록 아이콘을 터치하면 프로필 사진을 선택할 수 있습니다.</p>
			<h3>이름 등록하기</h3><!-- Sub title -->
            <p>프로필 이름을 등록할 수 있습니다. 설정> 계정설정 > 프로필 영역의 이름 입력탭에서 프로필에 사용할 이름을 입력할 수 있습니다.</p>
            <h3>생일 설정하기</h3><!-- Sub title -->
            <p>생일을 등록할 수 있습니다. 설정> 계정설정 > 프로필 영역의 생일설정 탭에서 자신의 생일을 설정할 수 있습니다.</p>
            <h3>성별 설정하기</h3><!-- Sub title -->
            <p>성별을 등록할 수 있습니다. 설정> 계정설정 > 프로필 영역의 성별설정 탭에서 자신의 성별을 설정할 수 있습니다.</p>
            <h3>Facebook 계정에서 61N 계정으로 전환하기</h3><!-- Sub title -->
            <p>Facebook 계정으로 회원가입을 한 사용자들은 이메일 계정으로 전환할 수 있습니다. 설정> 계정설정 > 계정설정탭을 터치하면 계정으로 사용할 이메일과 비밀번호를 입력하여 계정을 전환할 수 있습니다.</p>
            <h3>비밀번호 변경하기</h3><!-- Sub title -->
            <p>이메일 계정으로 회원가입을 한 사용자들이 자신이 설정한 비밀번호를 변경할 수 있습니다. 설정> 계정설정 > 계정설정탭을 터치하면 계정영역 두 번째 탭의 ‘비밀번호 변경’을 사용할 수 있습니다. 현재의 비밀번호를 입력하고, 변경할 새로운 비밀번호를 입력하여 계정 비밀번호를 변경할 수 있습니다.</p>
            <h3>회원 탈퇴하기</h3><!-- Sub title -->
            <p>설정> 계정설정 > 계정설정탭을 터치하면 회원탈퇴탭이 나타납니다. 회원탈퇴를 진행할 경우 자신의 타임라인에 등록된 모든 사진과 동영상이 삭제됩니다.</p>
