...
<div class="wrap">
    ...
    <div class="contents clearfix">
        <div class="dir"><p><a href="main.php">61N 매뉴얼</a> <span> &gt; </span> <a href="setting_1.php">61N 메뉴 - 설정하기</a> <span> &gt; </span> <strong>테마 설정하기</strong></p></div>
            ...
            <ul class="lmenu">
                ...
                <li class="on"><a href="">61N 메뉴 - 설정하기</a>
                	<ul class="lmenu">
                      ...
                      <li class="on"><a href="setting_5.php">테마 설정하기</a></li>
        ...
        <div class="cright clearfix">
            ...
            <p>앱에서 표시되는 테마색을 설정할 수 있습니다. 앱 메뉴의 설정> 테마설정에서 3가지의 테마색(Coral, Mint, Black)중 한 개를 선택하여 변경할 수 있습니다.</p>
